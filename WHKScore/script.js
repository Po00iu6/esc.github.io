...
let whkzcj = [0,352,426,471,432,458,482,473.5];
let yw = [0,79,75,91,102,94,94,85];
let sx = [0,45,86,80,78,90,89,107.5];
let yy = [0,81,79,86,57,100,94,84];
let wl = [0,28,31,48,41,41,40,50];
let hf = [0,55,80,79,68,69,76,72];
let sf = [0,64,75,87,86,64,89,75];
let pm = [1879,808,381,222,596,449,315,0];
