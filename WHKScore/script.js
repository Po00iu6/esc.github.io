...
let whkzcj = [0,352,426,471,432,458,482,473.5,441,430,520.5,459,465];
let yw = [0,79,75,91,102,94,94,85,103,86,98.5,94,81];
let sx = [0,45,86,80,78,90,89,107.5,78,0,103,74,91];
let yy = [0,81,79,86,57,100,94,84,73,0,98,75,99];
let wl = [0,28,31,48,41,41,40,50,42,0,62,54,42];
let hf = [0,55,80,79,68,69,76,72,70,0,81,81,75];
let sf = [0,64,75,87,86,64,89,75,75,0,78,81,59];
let pm = [1879,808,381,222,596,449,315,329,356,475,166,311,460];
